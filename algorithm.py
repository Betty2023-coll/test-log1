...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        if param == "BPIC12":
            log_skeleton = pm4py.discover_log_skeleton(BPIC12, noise_threshold=0.1, activity_key='concept:name', case_id_key='case:concept:name', timestamp_key='time:timestamp')
